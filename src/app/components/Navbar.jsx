      ...
      <nav className="fixed top-0 left-0 w-full flex items-center justify-between bg-white rounded-2xl shadow-md px-8 py-3 mt-8 z-50 scale-90">
        ...
        <ul className="flex items-center gap-8 font-bold text-gray-700 text-lg">
          <li className="relative">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline">
              ...
              </svg> LOCATIONS <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline ml-1"><path d="M7 10l5 5 5-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </button>
            {showLocations && (
              <div
